...
- [x] Pulse published to Google Docs via MCP — *Phase 3* (stub MCP; swap for real Docs MCP per runbook)
- [x] Draft email created in Gmail via MCP (self / alias) — *Phase 3* (stub MCP; swap for real Gmail MCP per runbook)
